          ...
          >
            ...
            <template v-slot:footer>
              <b-dropdown size="sm" style="float: right;">
                <b-dropdown-item v-b-modal.edit-forum @click="modalData(forum)">edit</b-dropdown-item>
...
export default {
  ...
  computed: {
    ...
    forumFilter: function() {
      return this.getForums.filter(forum => {
        ...
        return forum.title
          .toLowerCase()
          .match(this.forumSearch.toLowerCase());
      });
    }
  },
  ...
  methods: {
    addForum() {
      ...
      axios.post('https://trudeau-cda16.firebaseio.com/forum.json', newForum)
        .then(resp => {
