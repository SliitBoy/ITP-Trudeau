  ...
  <div class="settingsWrapper">
    <div class="topLeft">
      ...
      <div class="profileIcon">
        <img src="@/images/Trudeau logo.png" height="250" width="250" />
        <div class="profileIconButtons">
          <div class="signout">
            <router-link to="/login">
              <button class="profileBtns" href="#">Sign Out</button>
            </router-link>
          </div>

          <button class="profileBtns" id="changeBtn">Change Icon</button>
          <button class="profileBtns" id="removeBtn">Remove Icon</button>
        </div>
      </div>
    </div>
    <div class="topRight">
      <div
        class="innerTopRight"
        :class="{ invalid: $v.currentPassword.$error }"
      >
      ...
      <div class="innerTopRight" id="changePassword">
        <button type="submit" class="profileBtns" href="#">
          Change Password
        </button>
      </div>
    </div>
    <div class="bottomLeft">
      ...
      <div class="innerBottomLeft">
        ...
        <input
          type="email"
          id="email"
          placeholder="justin@trippinonquack.com"
          v-model="email"
        />
      </div>
      ...
      <div class="innerBottomLeft">
        ...
        <label for="showName" class="labels" id="options"
          >Show my name to others</label
        >
      </div>
      ...
      <div class="innerBottomLeft">
        ...
        <label for="showContact" class="labels" id="options"
          >Show my contact information to others</label
        >
      </div>
    </div>
    <div class="bottomRight">
      <div class="align">
        <h3 class="blend">blendthistext</h3>
        <!--for alignment-->
      </div>
...
.topRight {
  ...
  margin-left: 560px;
  margin-right: 85px;
  /*background-color: rgb(105, 83, 55);*/
  grid-template-areas: "innerTopRight";
  background-color: #2c2f33;
  color: white;
  font-family: "Poppins", sans-serif;
}
