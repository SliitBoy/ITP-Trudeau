...
export default {
  ...
  validations: {
    nic: {
      ...
      //return axios.get('https://trudeau-accounts.firebaseio.com/student.json?orderBy="nic"&equalTo="' + value +'"')
      //.then(res => {
  ...
  methods: {
    onCreate() {
      ...
      axios
        .post("https://trudeau-accounts.firebaseio.com/students.json", formData)
    ...
    createAccount({ commit, dispatch }, authData) {
      axios
        .post(
          "https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyBppMONz0sx74W3SV8IQqD6eCEjfdbZLE4",
          {
